...
class _MealDetailScreenState extends State<MealDetailScreen> {
  ...
  // Track which extras are selected by the user
  ...
  Widget build(BuildContext context) {
    ...
    // --- CHANGED: Multiply extra price by its selected quantity ---
    double selectedExtrasPrice = 0.0;
    for (var extra in meal.extras) {
      final quantity = _extraQuantities[extra.id] ?? 0;
      selectedExtrasPrice += (extra.price * quantity);
    }
                                ...
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        border: Border.all(color: mainTypeColor, width: 1.5),
                          ...
                          children: meal.extras.where((e) => e.isAvailable).map((extra) {
                            ...
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(12),
                                border: Border.all(
                                  color: quantity > 0 ? AppTheme.primaryOrange : AppTheme.lightGrey,
                                  ...
                                  Row(
                                    children: [
                                          ...
                                          onTap: () {
                                            setState(() {
                                              if (quantity > 1) {
                                                ...
                                                _extraQuantities.remove(extra.id);
                                              }
                                            });
                                          },
                                          child: const Icon(Icons.remove_circle_outline, color: AppTheme.primaryOrange, size: 26),
                                        ),
                                        const SizedBox(width: 10),
                                        SizedBox(
                                          width: 20,
                                      ...
                                      GestureDetector(
                                        ...
                                        child: const Icon(Icons.add_circle_outline, color: AppTheme.primaryOrange, size: 26),
                                      ),
                                    ],
                                  ),
                                ],
